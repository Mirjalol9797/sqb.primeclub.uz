      ...
      <div class="grid grid-cols-4 gap-2">
        ...
        >
          <div
            ...
            class="w-12 p-1 rounded-lg categories__item-icon transition-colors"
          >
            <img
        ...
        >
          <div
            ...
            class="w-12 p-2.5 rounded-lg categories__item-icon transition-colors"
          >
            <img src="/icons/p-offer/btn-all.svg" alt="все" />
          </div>
          <div
